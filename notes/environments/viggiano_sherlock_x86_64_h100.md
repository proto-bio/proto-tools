...
![Pass Rate](https://img.shields.io/badge/pass_rate-100%25-brightgreen) ![Passed](https://img.shields.io/badge/passed-37-brightgreen) ![Failed](https://img.shields.io/badge/failed-0-brightgreen) ![Skipped](https://img.shields.io/badge/skipped-1-lightgrey)
...
KRB5CCNAME=FILE:/tmp/krb5cc_389221_NS2MriONUb
LANG=en_US.UTF-8
LC_CTYPE=C.UTF-8
...
L_SCRATCH_JOB=/lscratch/viggiano/19326873
...
OMPI_MCA_orte_precondition_transports=0126e79900000000-0126e79900000000
...
PMIX_NAMESPACE=slurm.pmix.19326873.0
PMIX_RANK=0
PMIX_SECURITY_MODE=native
PMIX_SERVER_TMPDIR=/var/spool/slurmd/pmix.19326873.0/
PMIX_SERVER_URI2=pmix-server.19798;tcp4://127.0.0.1:57718
PMIX_SERVER_URI21=pmix-server.19798;tcp4://127.0.0.1:57718
PMIX_SERVER_URI3=pmix-server.19798;tcp4://127.0.0.1:57718
PMIX_SERVER_URI4=pmix-server.19798;tcp4://127.0.0.1:57718
PMIX_SERVER_URI41=pmix-server.19798;tcp4://127.0.0.1:57718
...
SLURM_CPU_BIND=quiet,mask_cpu:0x1800000E00E00000
SLURM_CPU_BIND_LIST=0x1800000E00E00000
...
SLURM_GTIDS=0
SLURM_JOBID=19326873
SLURM_JOB_ACCOUNT=euan
SLURM_JOB_CPUS_PER_NODE=8
SLURM_JOB_END_TIME=1774317929
SLURM_JOB_GID=11886
SLURM_JOB_GROUP=euan
SLURM_JOB_ID=19326873
SLURM_JOB_NAME=.ptshell-launcher.aTjBdG.sh
SLURM_JOB_NODELIST=sh04-14n01
SLURM_JOB_NUM_NODES=1
SLURM_JOB_PARTITION=brianhie
SLURM_JOB_QOS=normal
SLURM_JOB_START_TIME=1774274728
SLURM_JOB_UID=389221
SLURM_JOB_USER=viggiano
SLURM_LAUNCH_NODE_IPADDR=10.20.0.61
SLURM_LOCALID=0
...
SLURM_PMIXP_ABORT_AGENT_PORT=32838
SLURM_PMIX_MAPPING_SERV=(vector,(0,1,1))
SLURM_PRIO_PROCESS=0
SLURM_PROCID=0
SLURM_PTY_PORT=34938
SLURM_PTY_WIN_COL=212
SLURM_PTY_WIN_ROW=54
SLURM_SCRIPT_CONTEXT=prolog_task
SLURM_SRUN_COMM_HOST=10.20.0.61
SLURM_SRUN_COMM_PORT=35749
SLURM_STEPID=0
SLURM_STEPMGR=sh04-14n01
SLURM_STEP_GPUS=4
SLURM_STEP_ID=0
SLURM_STEP_LAUNCHER_PORT=35749
SLURM_STEP_NODELIST=sh04-14n01
SLURM_STEP_NUM_NODES=1
SLURM_STEP_NUM_TASKS=1
SLURM_STEP_TASKS_PER_NODE=1
SLURM_SUBMIT_DIR=/home/users/viggiano
SLURM_SUBMIT_HOST=sh04-ln01.stanford.edu
SLURM_TASKS_PER_NODE=1
SLURM_TASK_PID=19836
...
TMOUT=86400
TMPDIR=/tmp
TMUX=/tmp/tmux-389221/default,20416,0
...
```
BPT_MODEL_CACHE=/scratch/users/viggiano/model_weights/bio-programming-tools
...
|------|--------------|----------------------|----------|--------|
| `evo1` | yes | ✅ | 425.5s | ✅ Pass |
| `evo2` | yes | ✅ | 479.2s | ✅ Pass |
| `progen2` | yes | ✅ | 379.3s | ✅ Pass |
...
|------|--------------|----------------------|----------|--------|
| `blast` | no | ✅ | 48.2s | ✅ Pass |
| `crispr_tracr` | no | ✅ | 262.5s | ✅ Pass |
| `minced` | no | ✅ | 26.7s | ✅ Pass |
| `mmseqs` | no | ✅ | 35.8s | ✅ Pass |
| `pyhmmer` | no | ✅ | 31.3s | ✅ Pass |

### Inverse Folding (4/4)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `esm_if1` | yes | ✅ | 283.8s | ✅ Pass |
| `fampnn` | yes | ✅ | 362.8s | ✅ Pass |
| `ligandmpnn` | yes | ✅ | 329.3s | ✅ Pass |
| `proteinmpnn` | yes | ✅ | 151.3s | ✅ Pass |

### Masked Models (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `esm2` | yes | ✅ | 195.5s | ✅ Pass |
| `esm3` | yes | ✅ | 242.7s | ✅ Pass |

### Mock (1/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `mock_tools_env_report` | yes | — | 130.4s | ✅ Pass |
...
| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `orfipy` | no | ✅ | 33.7s | ✅ Pass |
| `prodigal` | no | ✅ | 13.5s | ✅ Pass |

### Rna Splicing (1/1)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `splice_transformer` | yes | ✅ | 150.4s | ✅ Pass |

### Sequence Alignment (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `local_colabfold_search` | no | — | 196.4s | ✅ Pass |
| `mafft` | no | ✅ | 24.9s | ✅ Pass |
...
| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `alphagenome` | yes | ✅ | 411.0s | ✅ Pass |
| `borzoi` | yes | ✅ | 181.1s | ✅ Pass |
| `enformer` | yes | ✅ | 159.5s | ✅ Pass |
| `segmasker` | no | ✅ | 37.6s | ✅ Pass |

### Structure Alignment (4/4)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `tmalign` | no | ✅ | 28.4s | ✅ Pass |
| `tmalign` | no | ✅ | 0.1s | ✅ Pass |
| `usalign` | no | ✅ | 38.1s | ✅ Pass |
...
| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `rfdiffusion3` | yes | ✅ | 336.8s | ✅ Pass |

### Structure Dynamics (1/1)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `bioemu` | yes | ✅ | 1935.5s | ✅ Pass |

### Structure Prediction (7/7)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Status |
|------|--------------|----------------------|----------|--------|
| `alphafold2` | yes | ✅ | 257.6s | ✅ Pass |
| `boltz2` | yes | ✅ | 418.8s | ✅ Pass |
| `chai1` | yes | ✅ | 424.9s | ✅ Pass |
| `esmfold` | yes | ✅ | 273.0s | ✅ Pass |
| `protenix` | yes | ✅ | 494.2s | ✅ Pass |
| `structure_metrics` | no | ✅ | 43.4s | ✅ Pass |
| `viennarna` | no | ✅ | 13.8s | ✅ Pass |

---
*Generated at 2026-03-23 13:29:26 by `pytest --env-report`*