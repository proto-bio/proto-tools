...
|------|--------------|----------------------|----------|-----------|--------|
| `evo1-sample` | yes | ✅ | 311.5s | `144023b` ✱ | ✅ Pass |
| `evo2-sample` | yes | ✅ | 339.2s | `144023b` ✱ | ✅ Pass |
| `progen2-sample` | yes | ✅ | 191.4s | `144023b` ✱ | ✅ Pass |
| `progen3-sample` | yes | ✅ | 33.4s | `144023b` ✱ | ✅ Pass |

### Gene Annotation (5/5)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `blast-create-db` | no | ✅ | 38.4s | `144023b` ✱ | ✅ Pass |
| `crispr-tracr` | no | ✅ | 157.5s | `144023b` ✱ | ✅ Pass |
| `minced-crispr` | no | ✅ | 19.6s | `144023b` ✱ | ✅ Pass |
| `mmseqs-clustering` | no | ✅ | 27.7s | `144023b` ✱ | ✅ Pass |
| `pyhmmer-hmmscan` | no | ✅ | 28.2s | `144023b` ✱ | ✅ Pass |

### Inverse Folding (4/4)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `esm-if1-sample` | yes | ✅ | 125.8s | `144023b` ✱ | ✅ Pass |
| `fampnn-pack` | yes | ✅ | 176.2s | `144023b` ✱ | ✅ Pass |
| `ligandmpnn-sample` | yes | ✅ | 216.2s | `144023b` ✱ | ✅ Pass |
| `proteinmpnn-sample` | yes | ✅ | 83.0s | `144023b` ✱ | ✅ Pass |

### Masked Models (3/3)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `ablang-embedding` | yes | ✅ | 130.7s | `144023b` ✱ | ✅ Pass |
| `esm2-embedding` | yes | ✅ | 117.7s | `144023b` ✱ | ✅ Pass |
| `esm3-embedding` | yes | ✅ | 123.8s | `144023b` ✱ | ✅ Pass |

### Mutagenesis (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `random-nucleotide-sample` | no | - | 0.0s | `144023b` ✱ | ✅ Pass |
| `random-protein-sample` | no | - | 0.0s | `144023b` ✱ | ✅ Pass |

### Orf Prediction (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `orfipy-prediction` | no | ✅ | 24.6s | `144023b` ✱ | ✅ Pass |
| `prodigal-prediction` | no | ✅ | 15.1s | `144023b` ✱ | ✅ Pass |

### Rna Splicing (1/1)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `splice-transformer-prediction` | yes | ✅ | 92.7s | `144023b` ✱ | ✅ Pass |

### Sequence Alignment (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `colabfold-search` | no | ✅ | 108.3s | `144023b` ✱ | ✅ Pass |
| `mafft-align` | no | ✅ | 24.9s | `144023b` ✱ | ✅ Pass |

### Sequence Scoring (4/4)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `alphagenome-predict-intervals` | yes | ✅ | 787.6s | `144023b` ✱ | ✅ Pass |
| `borzoi-ensemble` | yes | ✅ | 163.8s | `144023b` ✱ | ✅ Pass |
| `enformer-prediction` | yes | ✅ | 127.2s | `144023b` ✱ | ✅ Pass |
| `segmasker-score` | no | ✅ | 29.9s | `144023b` ✱ | ✅ Pass |

### Structure Alignment (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `tmalign-alignment` | no | ✅ | 24.9s | `144023b` ✱ | ✅ Pass |
| `usalign-alignment` | no | ✅ | 37.3s | `144023b` ✱ | ✅ Pass |

### Structure Design (1/1)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `rfdiffusion3-design` | yes | ✅ | 253.8s | `144023b` ✱ | ✅ Pass |

### Structure Dynamics (1/1)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `bioemu-sample` | yes | ✅ | 261.1s | `144023b` ✱ | ✅ Pass |

### Structure Prediction (7/7)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `alphafold2-prediction` | yes | ✅ | 104.3s | `144023b` ✱ | ✅ Pass |
| `alphafold3-prediction` | yes | ✅ | 72.1s | `144023b` ✱ | ✅ Pass |
| `boltz2-prediction` | yes | ✅ | 168.5s | `144023b` ✱ | ✅ Pass |
| `chai1-prediction` | yes | ✅ | 350.2s | `144023b` ✱ | ✅ Pass |
| `esmfold-prediction` | yes | ✅ | 132.8s | `144023b` ✱ | ✅ Pass |
| `protenix-prediction` | yes | ✅ | 413.1s | `144023b` ✱ | ✅ Pass |
| `viennarna-prediction` | no | ✅ | 21.9s | `144023b` ✱ | ✅ Pass |

### Structure Scoring (2/2)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `pyrosetta-energy` | no | ✅ | 65.0s | `144023b` ✱ | ✅ Pass |
| `structure-metrics` | no | ✅ | 25.0s | `144023b` ✱ | ✅ Pass |

### Testing (3/3)

| Tool | Requires GPU | Venv Build Succeeded | Duration | Tested At | Status |
|------|--------------|----------------------|----------|-----------|--------|
| `mock-cli-multi-gpu-tool-run` | yes | - | - | `144023b` ✱ | ⏭️ Skip |
| `mock-cli-tool-run` | yes | ✅ | 13.2s | `144023b` ✱ | ✅ Pass |
| `mock-jax-multi-gpu-tool-run` | yes | - | - | `144023b` ✱ | ⏭️ Skip |
| `mock-jax-tool-run` | yes | ✅ | 77.9s | `9be2916` ✱ | ✅ Pass |
| `mock-pytorch-multi-gpu-tool-run` | yes | - | - | `144023b` ✱ | ⏭️ Skip |
| `mock-pytorch-tool-run` | yes | ✅ | 130.8s | `144023b` ✱ | ✅ Pass |
