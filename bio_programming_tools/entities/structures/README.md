...
```python
from bio_programming_tools.entities.structures import Structure, BFactorType
...
```python
from bio_programming_tools.entities.structures import Structure, BFactorType
from bio_programming_tools.tools.inverse_folding import run_proteinmpnn_sample
