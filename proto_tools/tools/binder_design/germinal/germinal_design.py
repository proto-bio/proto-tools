...
class GerminalDesignMetrics(Metrics):
    ...
    metric_spec: ClassVar[dict[str, MetricSpec]] = {
        ...
        "i_ptm": {"availability": "always", "type": "float", "min": 0.0, "max": 1.0, "better_values_are": "higher"},
        "i_pae": {"availability": "always", "type": "float", "min": 0.0, "unit": "Å", "better_values_are": "lower"},
        "pae": {"availability": "always", "type": "float", "min": 0.0, "unit": "Å", "better_values_are": "lower"},
        "loss": {"availability": "always", "type": "float", "better_values_are": "lower"},
        "lm_ll": {"availability": "always", "type": "float", "better_values_are": "higher"},
        "helix": {"availability": "always", "type": "float", "better_values_are": "context-dependent"},
        "beta_strand": {"availability": "always", "type": "float", "better_values_are": "context-dependent"},
        # Filter metrics (configs/filter/{initial,final}/{vhh,scfv}.yaml)
        "clashes": {"availability": "after filtering", "type": "int", "min": 0, "better_values_are": "lower"},
        "sc_rmsd": {
        ...
        "binder_near_hotspot": {"availability": "after filtering", "type": "bool", "better_values_are": "higher"},
        ...
        "interface_hbonds": {"availability": "after filtering", "type": "int", "min": 0, "better_values_are": "higher"},
        ...
        "lis_lis": {"availability": "after validation", "type": "float", "better_values_are": "higher"},
        "lis_lia": {"availability": "after validation", "type": "float", "better_values_are": "higher"},
        ...
        "clashes_unrelaxed": {"availability": "after filtering", "type": "int", "min": 0, "better_values_are": "lower"},
        ...
        "sap_score": {"availability": "after filtering", "type": "float", "better_values_are": "lower"},
        "cdr_sap": {"availability": "after filtering", "type": "float", "better_values_are": "lower"},
