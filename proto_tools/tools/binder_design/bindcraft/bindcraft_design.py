...
class BindCraftMetrics(Metrics):
    ...
    metric_spec: ClassVar[dict[str, MetricSpec]] = {
        ...
        "binder_energy_score": {"type": "float", "unit": "REU", "better_values_are": "lower"},
        "dG": {"type": "float", "unit": "REU", "better_values_are": "lower"},
        "dSASA": {"type": "float", "min": 0.0, "unit": "Å^2", "better_values_are": "context-dependent"},
        "dG_per_dSASA": {"type": "float", "unit": "REU/Å^2", "better_values_are": "lower"},
        "interface_sasa_pct": {
            "type": "float",
            "min": 0.0,
            "max": 100.0,
        ...
        "packstat": {"type": "float", "min": 0.0, "max": 1.0, "unit": "fraction", "better_values_are": "higher"},
        # H-bonds
        "n_interface_hbonds": {"type": "float", "min": 0.0, "unit": "count", "better_values_are": "higher"},
        ...
        "n_interface_unsat_hbonds": {"type": "float", "min": 0.0, "unit": "count", "better_values_are": "lower"},
