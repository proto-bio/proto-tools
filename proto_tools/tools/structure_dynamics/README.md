...
Generate conformational ensembles that capture the range of structures a protein adopts at
equilibrium. Rather than returning a single static model, these tools sample many plausible
