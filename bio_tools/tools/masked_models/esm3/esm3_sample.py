...
from bio_programming.bio_tools.tools.masked_models.shared_data_models import MaskedModelInput
from bio_programming.bio_tools.tools.infra.tool_io import BaseToolOutput
