...
from bio_programming.bio_tools.tools.utils import determine_visible_devices
...
class EnvManager:
    ...
    def __init__(self, model_name: str, refresh: bool = False):
        ...
        # Get project root (five levels up: infra/ -> tools/ -> bio_tools/ -> bio_programming/ -> project_root/)
    ...
    def _determine_valid_model_name(self, model_name: str):
        ...
        """
        # Get project root (five levels up from this file)
        project_root = Path(__file__).parent.parent.parent.parent.parent
        tools_dir = project_root / "bio_programming" / "bio_tools" / "tools"
        available_models = []
