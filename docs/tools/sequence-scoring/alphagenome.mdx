...
<ParamField path="intervals" type="List[AlphaGenomeInterval]" required>
  Genomic intervals for prediction
</ParamField>
...
<ResponseField name="results" type="List[AlphaGenomePredictOutput]" required>
  Per-interval AlphaGenome prediction outputs
</ResponseField>
  </Tab>
...
<ParamField path="sequences" type="List[string]" required>
  Raw DNA sequences for prediction
</ParamField>
...
<ResponseField name="results" type="List[AlphaGenomePredictOutput]" required>
  Per-sequence AlphaGenome prediction outputs
</ResponseField>
  </Tab>
...
<ParamField path="variants" type="List[AlphaGenomeVariant]" required>
  Variants (with intervals) for prediction
</ParamField>
...
<ResponseField name="results" type="List[AlphaGenomePredictOutput]" required>
  Per-variant AlphaGenome prediction outputs
</ResponseField>
  </Tab>
...
<ResponseField name="results" type="List[AlphaGenomeScoreOutput]" required>
  Per-interval AlphaGenome score outputs
</ResponseField>
  </Tab>
...
<ResponseField name="results" type="List[AlphaGenomeScoreOutput]" required>
  Per-request AlphaGenome ISM score outputs
</ResponseField>
  </Tab>
...
<ParamField path="variants" type="List[AlphaGenomeVariant]" required>
  Variants (with intervals) for scoring
</ParamField>
...
<ResponseField name="results" type="List[AlphaGenomeScoreOutput]" required>
  Per-variant AlphaGenome score outputs
</ResponseField>
  </Tab>
</Tabs>
