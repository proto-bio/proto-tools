---
title: "ProteinMPNN"
description: "ProteinMPNN is a deep learning model for protein sequence design given a protein backbone structure ..."
---
...
2. **`batch_size`**: Generate 10-100 sequences and filter by perplexity. More sequences = more chances of finding good designs.
