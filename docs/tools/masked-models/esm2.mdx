...
<ParamField path="model_checkpoint" type="enum" default="esm2_t33_650M_UR50D">
  Name of the ESM2 model variant to use
...
<ParamField path="decoding_method" type="enum" default="entropy">
  Method for selecting positions to mutate
