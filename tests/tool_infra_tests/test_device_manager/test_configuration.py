...
# Configuration Tests
# ============================================================================
class TestDeviceManagerConfigurations:
    ...
    def test_env_var_managed_devices_number_format(self):
    ...
    def test_env_var_managed_devices_mixed_format(self):
...
class TestDevicePoolDiscovery:
    def test_auto_detect_devices(self, device_manager, mock_callback):
        """
    ...
    def test_cuda_visible_devices_respected(self, mock_2_gpus):
    ...
    # Managed devices
    # ====
    def test_managed_devices_override(self, device_manager, mock_callback):
    ...
    def test_managed_devices_validation_invalid_device(self, mock_2_gpus):
    ...
    def test_managed_devices_validation_invalid_device_number_format(self, mock_2_gpus):
    ...
    def test_managed_devices_validation_no_gpus(self, mock_0_gpus):
    ...
    def test_managed_devices_defaults_to_all_visible(self, mock_2_gpus):
    ...
    def test_cuda_visible_devices_one_visble(self):
    ...
    def test_no_gpus_available(self, no_gpus_manager):
