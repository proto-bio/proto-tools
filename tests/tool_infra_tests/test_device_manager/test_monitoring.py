...
class TestStatusMonitoring:
    ...
    @pytest.mark.slow
    def test_get_device_status_with_tools(self):
...
class TestMemoryTracking:
    """Tests for GPU memory tracking functions."""

    def test_get_gpu_memory_used_cpu_device(self, device_manager):
    ...
    def test_get_gpu_memory_used_invalid_device(self, device_manager):
    ...
    @pytest.mark.uses_gpu
    def test_get_gpu_memory_used_valid_device(self, device_manager):
    ...
    def test_get_instance_memory_stats_nonexistent_instance(self, device_manager):
    ...
    def test_tool_instance_get_memory_stats_no_worker(self):
    ...
    def test_memory_stats(self):
        ...
        try:
            with ToolInstance.persist_tool("mock_pytorch_tool", instance_name="mock_mem_test"):
                ...
                assert ti_stats["available"] == True, "Memory stats should be available"
                ...
                assert dm_stats["available"] == True
    ...
    @pytest.mark.uses_gpu
    @pytest.mark.slow
    def test_instance_memory_vs_total_gpu_memory(self):
