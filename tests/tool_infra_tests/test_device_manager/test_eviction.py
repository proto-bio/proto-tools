...
class TestLRUEviction:
    def test_lru_eviction_cpu_strategy(self, device_manager, mock_callback):
    ...
    def test_lru_eviction_restart_strategy(self, device_manager, mock_callback):
    ...
    def test_lru_eviction_respects_last_used_update(self, device_manager, mock_callback):
...
class TestEvictionCallbacks:
    ...
    def test_cpu_eviction_calls_callback_with_cpu(self, device_manager):
    ...
    def test_restart_eviction_calls_callback_with_shutdown(self, device_manager):
    ...
    def test_cpu_eviction_callback_failure_raises(self, device_manager):
    ...
    def test_restart_eviction_callback_failure_logs_but_continues(self, device_manager):
    ...
    def test_cpu_eviction_preserves_lru_ordering(self, device_manager):
    ...
    def test_missing_callback_raises(self, device_manager):
    ...
    def test_missing_callback_raises_even_without_gpus(self, no_gpus_manager):
    ...
    def test_gpu_request_raises_without_gpus(self, no_gpus_manager, mock_callback):
    ...
    def test_cpu_request_works_without_gpus(self, no_gpus_manager, mock_callback):
    ...
    def test_eviction_callback_does_not_update_last_used(self, device_manager):
    ...
    def test_multi_gpu_eviction_calls_callback_once(self, device_manager):
...
class TestTransientEviction:
    def test_transient_allocation_not_evicted(self, device_manager, mock_callback):
    ...
    def test_persistent_evicted_before_transient(self, device_manager, mock_callback):
