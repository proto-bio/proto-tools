...
from bio_programming.base_config import BaseConfig, ConfigField
from bio_programming.tools.tool_io import BaseToolInput
from bio_programming.tools.tool_registry import ToolRegistry, ToolSpec
...
def test_tool_output_error_access_raises_exception(clean_registry):
    ...
    from bio_programming.tools.tool_io import ToolExecutionError
