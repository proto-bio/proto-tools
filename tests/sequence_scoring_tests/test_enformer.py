...
class TestEnformerInputValidation:
    ...
    def test_enformer_input_valid(self):
        ...
        from bio_programming.bio_tools.tools.sequence_scoring.enformer import EnformerInput
    ...
    def test_enformer_config_valid(self):
        ...
        from bio_programming.bio_tools.tools.sequence_scoring.enformer import EnformerConfig
